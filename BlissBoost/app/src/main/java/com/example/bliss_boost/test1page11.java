...
public class test1page11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test1page11);
        ...
        Button btnd4=findViewById(R.id.btna9);
        btnd4.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                startActivity(new Intent(test1page11.this,test1page12.class));
            }
        });
    }
    private void speak(){
        TextView tv=findViewById(R.id.tvq9);
    ...
    public void onBackPressed(){
        startActivity(new Intent(test1page11.this,Home.class));
    }
}
